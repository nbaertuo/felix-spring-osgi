...
public class NineTeenLoginManagerImpl implements LoginManager {
	 ...
	 * 
	 * @see
	 * org.ertuo.douche.biz.nineteen.LoginManager#getCookies(java.lang.String)
	 */
	...
	public boolean login() {
		try {
			...
			HtmlPage page1 = webClientLocal
					.getHtmlPageByUrl(NineTeenConstant.login_url);
			...
			Set<Cookie> cookies = webClientLocal.webClient.getCookieManager()
					.getCookies(NineTeenConstant.domain);
