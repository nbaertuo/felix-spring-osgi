<html>
	...
	<body>
		<sfu:generateConfiguration fileSize="30"
			form="hrForm" buttonImageFile="/grails_logo.png" buttonWidth="104"
			buttonHeight="30" />
		<g:set var="pt" value="${applicationContext.getBean('pullTool')}"></g:set>


		<form action="edit" method="post" id="hrForm" name="hrForm"
			 onsubmit="return sfuSubmitForm(this);">
			<div>
				<div class="abc">
					<span class="gaia ops gsl">
						个人基本信息
 	 			</span>
					<g:hiddenField name="hrId"
						value="${fieldValue(bean:hr,field:'hrId')}" />
					<p>
						<label class="label" for="login">姓名:</label>
						<input type="text" name="name"
							value="${fieldValue(bean:hr,field:'name')}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="graduationDate" precision="day"
							years="${1960..2020}" noSelection="['':'select']" value="${hr?.graduationDate}" />
						<div class="errormsg">
							<p class="error">
				...
				<div class="abc">
					...
					<p>
						...
						<input type="text" name="post"
							value="${fieldValue(bean:hr,field:'post')}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="separationDate" precision="day"
							years="${1960..2020}" noSelection="['':'select']" value="${hr?.separationDate}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="titleDate" precision="day"
							years="${1960..2020}" noSelection="['':'select']" value="${hr?.titleDate}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="jobDate" precision="day"
							years="${1960..2020}" noSelection="['':'select']" value="${hr?.jobDate}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="practiceDate" precision="day"
							years="${1960..2020}" noSelection="['':'select']" value="${hr?.practiceDate}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="appointmentDate" precision="day"
							years="${1960..2020}" noSelection="['':'select']" value="${hr?.appointmentDate}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="regularizationDate" precision="day"
							years="${1960..2020}" noSelection="['':'select']" value="${hr?.regularizationDate}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<input type="text" name="hrNo"
							value="${fieldValue(bean:hr,field:'hrNo')}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="retirementDate" precision="day"
							years="${1990..2020}" noSelection="['':'select']" value="${hr?.retirementDate}" />
						<div class="errormsg">
							<p class="error">
					...
					<p>
						...
						<g:datePicker name="entryDate" precision="day"
							years="${1990..2020}" noSelection="['':'select']" value="${hr?.entryDate}" />
						<div class="errormsg">
							<p class="error">
				...
				<div class="buttomDiv">
					<input type="SUBMIT" value="提交。" name="submitbutton" id="submitbutton"
						style="width: 10em;">
				</div>
			</div>
