...
public class CompanyDAO  implements ICompanyDAO {
    ...
    @Autowired
    public CompanyDAO(DataSource dataSource, IIndustryDAO industryDAO,SessionFactory sessionFactory ) {
    ...
    public List<Company> findByName(String name) {
        ...
        try {
            list= getHibernateTemplate(sessionFactory).loadAll(Company.class);
    ...
    protected HibernateTemplate getHibernateTemplate(SessionFactory sessionFactory) {
